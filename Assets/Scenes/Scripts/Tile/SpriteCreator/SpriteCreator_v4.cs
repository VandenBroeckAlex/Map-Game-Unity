...
//                                {
//                                    sprite.neighboreId.Add(lastColor);
//                                    continue;
//                                }

//                                if (y != 0 )
//                                {
//                                    if (!sprite.neighboreId.Any(c => c.SequenceEqual(lastColor)))
//                                    {
//                                        sprite.neighboreId.Add(lastColor);
//                                    }
//                                }  
...
//                if (spriteObjList[_indexLeft].neighboreId.Contains(ColorUtils.GenerateColorFormat(spriteObjList[_indexRight].spriteColor)) || spriteObjList[_indexLeft].spriteColor == spriteObjList[_indexRight].spriteColor)
//                {
                    
//                    continue;
//                }

//                spriteObjList[_indexLeft].neighboreId.Add(ColorUtils.GenerateColorFormat(spriteObjList[_indexRight].spriteColor));
//                spriteObjList[_indexRight].neighboreId.Add(ColorUtils.GenerateColorFormat(spriteObjList[_indexLeft].spriteColor));
...
//                    if (ListObjJSONTemp[i].spriteColor[2] == 1f && ListObjJSONTemp[i].spriteColor[0] < 0.4999)
//                    {
...
//        // Ensure neighore goes both direction V01
//        if (autoNeighbore == true)
//        {
